...
SUBMENUS = {
    ...
    "sub:sdr": [
        ...
        ("ADS-B Aircraft",   "radio/sdr.sh adsb",         "track aircraft (dump1090)",              "fullscreen", "✈️"),
    ...
    "sub:adsb": [
        ...
        ("Set Home (Manual)", "_adsb_home_picker",  "type lat/lon or pick a preset metro",     "action",     "✏️"),
        ...
        ("Receiver (raw)",    "radio/sdr.sh adsb",  "launch dump1090 interactive",             "fullscreen", "✈️"),
